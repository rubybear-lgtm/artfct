...
trait HasTeams
{
    ...
    /**
     * Get all of the teams the user administers.
     *
     * @return HasManyThrough<Team, Membership, $this>
     */
    public function adminTeams(): HasManyThrough
    {
    ...
    public function toTeamPermissions(Team $team): TeamPermissions
    {
        ...
        return new TeamPermissions(
            ...
            canChangeAuthMode: $role?->hasPermission(TeamPermission::ChangeAuthMode) ?? false,
        );
    }
